...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='activity',
            options={'verbose_name': 'actualit\xe9 (\u2193)', 'verbose_name_plural': 'activities'},
        ),
        migrations.AlterModelOptions(
            name='award',
        ...
        migrations.AlterField(
            ...
            name='languages',
            field=models.CharField(default=b'fr', max_length=128),
        ),
        migrations.AlterField(
            model_name='userprofile',
            name='primary_language',
            field=models.CharField(default=b'fr', max_length=16, choices=[(b'fr', b'French')]),
        ),
    ]
